...
const Courses: React.FC<CoursesProps> = () => {
  return (
    <div className="flex flex-col gap-7 w-full h-auto items-center md:items-start md:px-50 justify-center pb-1.5">
      <MyDivider className="w-[90%] md:w-[50%] md:self-center" />
      ...
      <Link href={"/departments"} className="self-center">
      <button
        
        className="bg-dark-blue text-custom-white cursor-pointer px-4 py-2 rounded-xl
